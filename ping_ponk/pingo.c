...
int main()
{
    ...
    Game game = {
        .left = {.rect = {PLYR_OFFSET, SCRN_HEIGHT * 0.25f, PLYR_WIDTH, PLYR_HEIGHT},
                 .texture = IMG_LoadTexture(renderer, "assets/boxer.png"),
                 .status = Ready,
                 .score = 0},
        .right = {.rect = {SCRN_WIDTH - PLYR_WIDTH - PLYR_OFFSET, SCRN_HEIGHT * 0.75f, PLYR_WIDTH, PLYR_HEIGHT},
                  .texture = IMG_LoadTexture(renderer, "assets/boxer.png"),
                  .status = Ready,
                  .score = 0},
        .ball = {.r = ballSize / 2.0f,
                 .rect = {SCRN_WIDTH / 2.0f - ballSize / 2.0f, SCRN_HEIGHT / 2.0f - ballSize / 2.0f, ballSize,
                          ballSize},
                 .vx = BALL_SPEED,
                 .vy = BALL_SPEED * 0.5f,
